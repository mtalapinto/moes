...
def echellogram_plot():
    ...
    det = [0, 15., 4096, 2048]
    spec = spectrograph.tracing_det(slit, det)
    ...
    while omin <= omax:
        ...
        specout = spectrograph.tracing_det(slit, det)
        ...
        specmask = spectrograph.tracing_det(maskout, det)
    ...
    plt.savefig(sampdir + 'echellogram_feros.png')
    plt.show()
...
def echellogram_plot():
    ...
    while omin <= omax:
        ...
        maskout = echelle_orders.init_g2mask(maskord, omin)
        specmask = platospec_moes.tracing_full_det(maskout, det)
    ...
    clb.ax.set_ylabel('Order number', size=12)
    sampdir = '/home/marcelo/Documentos/papers/sampling/'
    plt.savefig(sampdir+'echellogram_platospec.png')
    plt.show()
    # print(slitout)
