...
def do_moes_full_spectrum(rv, fcam):
    ...
    #basedir = '/media/eduspec/TOSHIBA EXT/platospec/data/f' + str(int(fcam)) + 'mm/'
    basedir = '/home/eduspec/Documentos/moes/platospec/data/f' + str(int(fcam)) + 'mm/'
    #outpath = '/media/eduspec/TOSHIBA EXT/fideos_moes/data/f'+str(int(fcam))+'mm/slit_files/'+str(int(rv))+'/'

    slitfiles = basedir+'/slit/'+str(int(rv))+'/'
    outpath = basedir + '/moes/' + str(int(rv)) + '/'
    ...
    while omin <= omax:
        ...
        if not os.path.exists(fileout):
            ...
            specmoes = platospec_moes.tracing_full_fcam(datord, fcam)
